...
<section class="services bg-gray" id=boardinghouse style="margin-top: -10px;"> 
  <!--container start-->
  <div class="container">
    <div class="section-title" style="margin-bottom: -15px;">
      <h3>My Ongoing <span>Rent</span></h3>
    </div>
    <!--row start-->
   <div class="row serviceList">
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        ...
        <a href="messages.php?tenant_id=<?php echo $rooms['tenant_id']; ?>" id="chat" class="btn btn-primary">Chat Owner</a>
    </div>
    <!--col end--> 
    <?php endforeach; ?>
</div>
