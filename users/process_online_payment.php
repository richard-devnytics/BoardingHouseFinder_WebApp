<?php
require '../vendor/autoload.php'; // Ensure Composer autoloading
...
$rental_fee = isset($_GET['rental_fee']) ? $_GET['rental_fee'] : 0; // Default value
...
$requestData = [
    'data' => [
        'attributes' => [
            ...
            'line_items' => [
                [
                    'amount' => round($rental_fee * 100), // Amount in centavos (e.g., 10000 = 100.00 PHP)
                    'currency' => 'PHP',
                    'name' => "Reservation ID: $reservation_id", // Name of your product
                    'quantity' => 1,
                ],
            ],
            'mode' => 'payment', // Specify the mode (e.g., payment)
            'success_url' => "https://tueogan.com/users/process_success_payment.php?reservation_id=$reservation_id&rental_fee=$rental_fee", 
