...
$sqlReservations = "
    SELECT reservations.*, room.room_id, room.bedspace
    FROM reservations
    INNER JOIN room ON reservations.room_id = room.room_id
    WHERE reservations.status = 'pending' 
    AND reservations.tenant_id = $tenant_ID
";
...
<head>
<meta charset="UTF-8">
<title>Tueogan | Pending Reservations</title>
                        ...
                        <?php foreach ($reservations as $reservation) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="tenantConfirmReservation.php?id=<?php echo $reservation['reservation_id']; ?>&user_id=<?php echo $userID; ?>" class="btn btn-success" onclick="return confirm('Are you sure you want to confirm this reservation?')">Confirm</a>
