...
if (isset($_GET['id']) && isset($_GET['home_id'])) {
    ...
    try {
        ...
        $sqlDeleteReservation = "UPDATE reservations SET status='admin_cancelled' WHERE reservation_id = ?";
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                $sqlUpdateHomeStatus = "UPDATE holiday_homes SET available_rooms = available_rooms + 1 WHERE home_id = ?";
