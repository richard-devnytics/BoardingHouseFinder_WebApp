...
if (isset($_GET['home_id']) && isset($_GET['tenant_email'])) {
    ...
    try {
        ...
        $sqlConfirmList = "UPDATE holiday_homes SET admin_approved='unlisted' WHERE home_id = ?";
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                try {
                    ...
                    // Content
                    $mail->isHTML(true);
                    $mail->Subject = 'Action Required: Unlisted';
                    $mail->Body = 'Dear Owner,<br><br>Your Boarding House has been unlisted for some reason. Please contact Tueogan at 09983069056 or email us at tueogan@gmail.com.<br><br>Thank you!<br>From: Tueogan-Admin';
